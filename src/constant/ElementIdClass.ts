export const aPdfViewerIds = {
  ...
  _ANNOTATION_LAYER: 'annotation-Layer',
  _ANNOTATION_DRAWING_LAYER: 'a-annotate-drawing-layer',
  _LOADING_CONTAINER: 'loading-container',
  _INPUT_PAGE_NUMBER: 'inputPageNumberContainer',
  _CURRENT_PAGE_INPUT: 'currentPageInput',
};

export const aPdfViewerClassNames = {
  ...
  _A_ANNOTATION_DRAWING_LAYER: 'a-annotation-drawing-layer',
  ...
  _A_FIRST_PAGE_CONTAINER: 'a-first-page-container',
  _A_PERVIOUS_PAGE_CONTAINER: 'a-previous-page-container',
  _A_NEXT_PAGE_CONTAINER: 'a-next-page-container',
  _A_LAST_PAGE_CONTAINER: 'a-last-page-container',
  _A_ZOOM_CONTAINER: 'a-zoom-container',
  _A_ROTATE_CONTAINER: 'a-rotate-container',
  _A_PRINT_CONTAINER: 'a-print-container',
  _A_DOWNLOAD_CONTAINER: 'a-download-container',
  _A_SEARCH_CONTAINER: 'a-search-container',
