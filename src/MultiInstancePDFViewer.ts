...
/**
 * Multi-instance PDF viewer that supports loading multiple PDFs simultaneously
 * with complete isolation between instances.
 *
 * This replaces the old PdfViewerKit with a proper multi-instance architecture.
 */
export class MultiInstancePDFViewer {
  ...
  static async load(options: LoadOptions): Promise<PDFViewerInstance> {
    this.initialize();
    return await this._manager.load(options);
  }
...
export { PDFViewerInstance } from './core/PDFViewerInstance';
export { PDFViewerManager } from './core/PDFViewerManager';
export { InstanceState } from './core/InstanceState';
export { InstanceEventEmitter } from './core/InstanceEventEmitter';
export { InstanceCanvasPool } from './core/InstanceCanvasPool';
export { InstanceImageBitmapPool } from './core/InstanceImageBitmapPool';
export { InstanceWorkerManager } from './core/InstanceWorkerManager';
export { InstanceWebViewer } from './core/InstanceWebViewer';
...
export default MultiInstancePDFViewer;
