...
declare class PageVirtualization {
     ...
     */
    constructor(options: ViewerLoadOptions, parentContainer: HTMLElement, container: HTMLElement, totalPages: number, pdfViewer: WebViewer, selectionManager: SelectionManager, searchHighlighter: SearchHighlighter, pageBuffer?: number);
    ...
    private _debouncedScrollHandler;
    /**
     ...
     */
    private _calculatePagesToFillViewport;
    /**
     * Render pages visible in the initial viewport.
     */
    private _renderInitialPages;
    /**
     ...
     */
    private _calculatePageFromScroll;
    /**
     ...
     */
    private _cleanupOutOfBufferPages;
    /**
     ...
     */
    private _renderHighResImage;
    destroy(): void;
}
export default PageVirtualization;
//# sourceMappingURL=PDFPageVirtualization.d.ts.map